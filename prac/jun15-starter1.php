  ...
  <head>
    <script type="text/javascript">
      ...
      function checkForError (textbox, checkbox) {
        ...
        else if(textbox.value == textbox.defaultValue)
        	checkbox.checked = false;
         
        
      }
      
      function setTextbox (textbox, checkbox)
      {		if(!checkbox.checked){
	  		textbox.myOldValue = textbox.value;
	  		textbox.value = textbox.defaultValue;
	  		}
	  		else if(textbox.myOldValue != undefined){
				textbox.value = textbox.myOldValue;
	  ...
	  Function Check(ID)
	  {
	  	if(ID.value.match("^\\s*[0-9]*[1-9]+[0-9]*$"))
	  	{
