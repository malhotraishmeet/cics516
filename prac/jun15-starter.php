...
<html>
  ...
  <head>
    <script type="text/javascript">
      ...
      function setCheckbox (t,c) {
        c.checked = t.value != t.defaultValue;
      }
      function setTextbox (t,c) {
        if (! c.checked) {
          t.myOldValue = t.value;
          t.value      = t.defaultValue;
        } else if (t.myOldValue != undefined) {
          t.value = t.myOldValue;
        }
      }
      ...
      function checkInsertButton() {
        var id = $("insertId");
        var isEnabled = !id.isValueBlank && id.isValueValid;
        $("insertButton").disabled = !isEnabled;
      }
      function checkId(id) {
        id.isValueBlank = id.value.match("^\\s*$");
        id.isValueValid = id.value.match ("^\\s*[0-9]*[1-9]+[0-9]*$");
        if (id.isValueValid || id.isValueBlank) {
          removeClassName (id, "error");
          setErrorMessage ("");
          addClassName ($("errLine"), "hidden");
        } else {
          addClassName (id, "error");
          setErrorMessage ("1..N");
          removeClassName ($("errLine"), "hidden");
        }
        checkInsertButton();
      }
    </script>
  ...
  <body>
    ...
    <form method="post" action="">
      <table>
            ...
            <tr>
              ...
              <td>
                <input type  = "checkbox"
                       ...
                       name  = "selected[]"
                       onclick = "setTextbox($('t<?php print $rowIndex;?>'),this);"
              ...
              <td>
                <input type  = "text"
                       ...
                       class = "name"
                       onchange = "setCheckbox(this,$('c<?php print $rowIndex;?>'));"
                />
              </td>
            </tr>
          <?php endforeach ?>
        <tr>
          <td><input type="submit" name="insert" value="Insert" id="insertButton" disabled="True"/></td>
          <td><input id="insertId"
                     type="text"
                     name="iId"
                     class="id"
        ...
        <tr id="errLine" class="hidden"><td></td><td><p id="errMsg"></p></td></tr>
      </table>
